    ...
    <section className="flex min-h-[100svh] items-center justify-center px-6 py-16 text-white">
      <div className="w-full max-w-xl text-left">
        ...
        <details className="group mt-16 text-left">
          <summary className="mx-auto flex min-h-11 w-fit cursor-pointer list-none items-center gap-1.5 rounded-lg px-2 py-3 text-sm font-medium text-brand-400 transition-colors hover:text-brand-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-400 [&::-webkit-details-marker]:hidden">
          ...
          <form
            onSubmit={onSubmit}
            noValidate
            className="mx-auto mt-4 max-w-sm rounded-xl border border-brand-700 bg-brand-950/50 p-5"
          >
            <label
